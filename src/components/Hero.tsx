...
export default function Hero() {
  return (
    <section className="bg-neutral-3">
      <div className="max-w-7xl mx-auto px-6 py-20 my-30 md:my-0 flex flex-col-reverse md:flex-row items-center md:justify-between gap-12 h-screen">
    ...
    >
        <img src="/hero1.png" alt="Hero Image 1" className="w-85 h-auto" style={{ transform: "rotate(-20deg)" }} />
    </motion.div>
    <motion.div
      ...
      transition={{ duration: 3, repeat: Infinity }}
    >
        <img src="/hero2.png" alt="Hero Image 2" className="w-88 h-auto" style={{ transform: "rotate(20deg)" }} />
    </motion.div>
    </section>
  );
}
